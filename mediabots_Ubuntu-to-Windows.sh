...
link1_status=$(curl -Is https://www.dropbox.com/s/ddidb6g90q8sf4y/WS2012R2.ISO?dl=1 | grep HTTP | cut -f2 -d" ")
...
if [ $link1_status = "200" ] ; then 
	sudo wget -P /mediabots https://www.dropbox.com/s/ddidb6g90q8sf4y/WS2012R2.ISO?dl=1
